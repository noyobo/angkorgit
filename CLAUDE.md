...
├── branch.rs         ← list(+ahead/behind), create/delete/rename, delete_local_and_remote
...
- Every new engine function gets an integration test in `tests/git_engine.rs`
  (72 tests; TempRepo fixture creates real repos in temp dirs; uses `angkorgit_lib::test_api`).
