...
- Every new engine function gets an integration test in `tests/git_engine.rs`
  (73 tests; TempRepo fixture creates real repos in temp dirs; uses `angkorgit_lib::test_api`).
