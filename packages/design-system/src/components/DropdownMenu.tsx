...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <Menu.Portal>
    <Menu.Content
      ...
      className={cn(
        'z-50 min-w-[10rem] max-h-[min(70vh,32rem)] overflow-y-auto overflow-x-hidden rounded-lg border border-border bg-surface-overlay p-1 shadow-soft animate-slide-up',
        className,
      )}
      {...props}
    />
